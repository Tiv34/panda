...
<div class="row about-block align-items-center">
    <div class="mb-4 text-center row align-items-center">
        <div class="col-lg-6">
...
<!--                <div class="img-shadow-2"></div>-->
                <ul class="fs-5">
                    ...
                    <li>мечтала поиграть на музыкальных инструментах – хоть каком-нибудь и особенно на тех, которые были
                        закрыты за стеклом
                    </li>
                    <li><span class="bom-bom">Чуть-чуть хотела замуж!</span> в подготовительной группе «назначила день
                        свадьбы в апреле», но бабушка жениха была против
                    </li>
                </ul>
            </div>
            <div class="text col my-auto text-about" data-id="2">
                <ul class="fs-5">
                    ...
                    <li>Учителя из рук директора школы мне вручили грамоту «Министр финансов», потому что я всегда
                        собирала со всех денег и вела подсчет по экскурсиям и театрам.
                    </li>
...
<!--                <div class="img-shadow-2"></div>-->
            ...
            <div class="text col my-auto text-about" data-id="3">
                <ul class="fs-5">
                    <li>Пришла на факультет по автоматизации за мужем.</li>
                    <li>Честно ходила на все праздники и в походы с однокурсниками, получала двойки за электротехнику в
                        надежде на помощь сокурсников.
                    </li>
...
<!--                <div class="img-shadow-2"></div>-->
            ...
            <div class="text col my-auto text-about" data-id="5">
                <p class="fs-5">Тяжелые мысли для 20-летней девушки - Что делать, когда достиг основных желаний?<br>Первый
                    план до 35 лет я написала в 26 лет:</p>
                <ul class="fs-5">
                    <li>Второе высшее</li>
                    <li>Работа на 5 тыс.долларов</li>
                    <li>Выучить английский</li>
                    <li>Вернуться в форму 55 кг как заканчивала школу</li>
...
<!--                <div class="img-shadow-2"></div>-->
            ...
            <div class="text col my-auto text-about" data-id="6">
                <ul class="fs-5">
                    ...
                    <li>Второе высшее – маркетинг</li>
                    <li>Работа мечты «Вимм-Билль-Данн» в маркетинге. Дерзко, модно, человечно!
                        <ol>
                            <li>Окружение на работе: бренд менеджеры – это инопланетяне в быту!</li>
                            <li>Должность «по случаю» - среди претендентов я одна не отказалась</li>
                        </ol>
                    </li>
                    <li>Фольцваген автомат василькового цвета</li>
                    <li>Фитнес три раза в неделю (О! Леха!!!)</li>
                    <li>Ролики и перелом руки.</li>
                    <li>Горные лыжи</li>
                    <li>Отпуск летом море, зимой - лыжи и иногда поездки в города «посмотреть»</li>
...
<!--                <div class="img-shadow-2"></div>-->
            ...
            <div class="text col my-auto text-about" data-id="8">
                <ul class="fs-5">
                    <li>Две свадьбы детей</li>
                    <li>Новая квартира</li>
                    <li>Новые увлечения: рисование, скорочтение, настольный теннис, плаванье и вокал</li>
                    <li>Новые мерседесы красные (шуба старая)</li>
                    <li>Четыре внука</li>
                    <li>Новые друзья</li>
