...
character1.innerHTML = 'па';
character2.innerHTML = 'си';
character3.innerHTML = 'С';
character4.innerHTML = 'бо';
...
new MojsPlayer({ add: timeline, isPlaying: true, isRepeat: false, isHidden: true, isSaveState:false });

window.onload = () => document.querySelector('.submit-repeat').classList.remove('hidden');
